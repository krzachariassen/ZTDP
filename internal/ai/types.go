...
// *** ORCHESTRATION AND PLANNING TYPES ***

// ExecutionPlan represents a multi-step execution plan for complex operations
type ExecutionPlan struct {
	ID           string              `json:"id"`
	Scenario     string              `json:"scenario"`     // what the user wants to achieve
	Steps        []ExecutionStep     `json:"steps"`        // ordered list of steps
...
type ExecutionStep struct {
	...
	Operation    string                 `json:"operation"`        // application_creation, service_creation, etc.
	ResourceType string                 `json:"resource_type"`    // application, service, database, etc.
	...
	Parameters   map[string]interface{} `json:"parameters"`       // parameters for this step
	Status       string                 `json:"status"`           // pending, executing, completed, failed
	Result       interface{}            `json:"result,omitempty"` // result data from execution
	Error        string                 `json:"error,omitempty"`  // error message if failed
	StartedAt    *time.Time             `json:"started_at,omitempty"`
	CompletedAt  *time.Time             `json:"completed_at,omitempty"`
}

// OrchestrationCapability represents a capability that can be orchestrated
type OrchestrationCapability struct {
	Operation      string   `json:"operation"`       // application_creation, service_creation, etc.
	ResourceTypes  []string `json:"resource_types"`  // supported resource types
	...
	OptionalParams []string `json:"optional_params"` // optional parameters
}
